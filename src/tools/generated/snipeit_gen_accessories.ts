// AUTO-GENERATED from /accessories (accessories). Do not edit by hand.
import { z } from "zod";
...
export function register(server: McpServer, ctx: ServerContext): void {
  server.registerTool(
    "snipeit_gen_accessories",
    {
      title: "/accessories",
      description: "/accessories — generated from Snipe-IT OpenAPI accessories",
    ...
    async (a) => {
      try {
        const res = await ctx.client.request("GET", `/accessories`, { body: undefined, query: {limit: a.limit, offset: a.offset, search: a.search, order_number: a.order_number, sort: a.sort, order: a.order, expand: a.expand} as Record<string, unknown> | undefined });
